        ...
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-sm-7 form-control-static">
                    <?php echo $result->card()->firstName . " " . $result->card()->lastName ?> 
                </div>
            </div>
            <div class="row">
                <label class="col-sm-5 control-label">Card type </label>
                <div class="col-sm-7 form-control-static">
                    <?php echo $result->card()->cardType ?>
                </div>
            </div> 
        </div> 
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-sm-7 form-control-static">
                    **** **** **** <?php echo $result->card()->last4 ?>
                </div>
            </div>
            <div class="row">
                <label class="col-sm-5 control-label"> Expiry</label>
                <div class="col-sm-7 form-control-static">
                    <?php echo $result->card()->expiryMonth . "/"  .  $result->card()->expiryYear ?>
                </div>
            </div> 
        </div>
    </div>
